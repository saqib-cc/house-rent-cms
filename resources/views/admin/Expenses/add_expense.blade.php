    ...
    @section('content')
       ...
       <section class="content">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Add Expence</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">  
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item active"><a href="{{url('view_expense')}}">Expences</a></li>
                <li class="breadcrumb-item ">Add Expence</li>
              </ol>
            </div><!-- /.col -->
          </div><!-- /.row -->
         <div class="row">  
                 ...
                 @csrf
                  <div class="card-body">
                    ...
                    <div class="form-group">
                      ...
                      <textarea name="description" class="form-control" id="description" cols="5" rows="2" placeholder="Expense Description"></textarea>
                      @error('description')
                          <span class="text-danger">{{$message}}</span>    
                      @enderror
                    </div>
