          ...
          <div class="row">
              <div class="col-md-4 col-sm-6 col-xs-6">
                  <div class="apartments-content">
                      <div class="image-content">
                         <a href="apartment-single.html"><img src="{{asset('frontend/assets/images/apartment/apartment-one.png')}}" alt="apartment" /></a>
                      </div><!-- /.image-content -->
              ...
              <div class="col-md-4 col-sm-6 col-xs-6">
                  <div class="apartments-content">
                      <div class="image-content">
                          <a href="apartment-single.html"><img src="{{asset('frontend/assets/images/apartment/apartment-two.png')}}" alt="apartment" /></a>
                      </div><!-- /.image-content -->
              ...
              <div class="col-md-4 col-sm-6 col-xs-6">
                  <div class="apartments-content">
                      <div class="image-content">
                          <a href="apartment-single.html"><img src="{{asset('frontend/assets/images/apartment/apartment-three.png')}}" alt="apartment" /></a>
                      </div><!-- /.image-content -->
              ...
              <div class="col-md-4 col-sm-6 col-xs-6">
                  <div class="apartments-content">
                      <div class="image-content">
                          <a href="apartment-single.html"><img src="{{asset('frontend/assets/images/apartment/apartment-four.png')}}" alt="apartment" /></a>
                      </div><!-- /.image-content -->
              ...
              <div class="col-md-4 col-sm-6 col-xs-6">
                  <div class="apartments-content">
                      <div class="image-content">
                          <a href="apartment-single.html"><img src="{{asset('frontend/assets/images/apartment/apartment-five.png')}}" alt="apartment" /></a>
                      </div><!-- /.image-content -->
              ...
              <div class="col-md-4 col-sm-6 col-xs-6">
                  <div class="apartments-content">
                      <div class="image-content">
                          <a href="apartment-single.html"><img src="{{asset('frontend/assets/images/apartment/apartment-six.png')}}" alt="apartment" /></a>
                      </div><!-- /.image-content -->
